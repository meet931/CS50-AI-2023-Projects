...
knowledgeBase = And(
    # A, B, C can be either Knight or Knave
    Or(AKnight, AKnave),
    Or(BKnight, BKnave),
    Or(CKnight, CKnave),
...
knowledge2 = And(
    knowledgeBase,
    # A says "We are the same kind."
    Implication(AKnight, Or(And(AKnight, BKnight), And(BKnave, BKnave))),
    Implication(AKnave, Not(Or(And(AKnight, BKnight), And(BKnave, BKnave)))),
